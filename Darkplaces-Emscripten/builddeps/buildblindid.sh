...
LIBS=../gmp/lib/libgmp.a emconfigure ./configure --libdir=`pwd`/../d0_blind_id/lib --includedir=`pwd`/../d0_blind_id/include --oldincludedir=`pwd`/../d0_blind_id/include --bindir=`pwd`/../d0_blind_id/bin
cp ../gmp/lib/libgmp.a . 
