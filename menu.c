...
static void M_Menu_Options_Graphics_AdjustSliders (int dir)
{
	...
	else if (options_graphics_cursor == optnum++) Cvar_SetValueQuick (&r_bloom_brighten,                        bound(1, r_bloom_brighten.value + dir * 0.0625, 1));
...
static void M_Options_Graphics_Draw (void)
{
	...
	M_Options_PrintSlider(  "        Bloom Intensity", r_hdr.integer || r_bloom.integer, r_bloom_brighten.value, 0.125, 4);
