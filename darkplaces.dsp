...
# ADD LINK32 ws2_32.lib winmm.lib user32.lib gdi32.lib comctl32.lib dinput.lib dxguid.lib /nologo /subsystem:windows /LARGEADDRESSAWARE /machine:I386
...
# ADD LINK32 ws2_32.lib winmm.lib user32.lib gdi32.lib comctl32.lib dinput.lib dxguid.lib /nologo /subsystem:windows /LARGEADDRESSAWARE /debug /machine:I386 /out:"Debug/darkplaces-debug.exe" /pdbtype:sept
# SUBTRACT LINK32 /nodefaultlib
